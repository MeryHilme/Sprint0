...
public class CandidatController {
	 ...
	 * 
	 * @RequestMapping(value = "/delete/{noCandidat}",method = {
	 * RequestMethod.DELETE })
	 * 
	 * @ResponseBody public void delete(@PathVariable("noCandidat") String
	 * noCandidat) { candidatRepository.deleteById(noCandidat); }
	 */
