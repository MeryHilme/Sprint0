...
public class CandidatService {
	...
	public Candidat getCandidat(String noCandidat) {
			...
			for(Candidat candidat: c) {
				if(candidat.getNoCandidat().equalsIgnoreCase(noCandidat)) return candidat;
			}
		    return null;
		}
	...
	*/
	...
	public Candidat getUniversiteOrigine(String universiteOrigine) {
		...
		for(Candidat candidat: cd) {
			if(candidat.getUniversiteOrigine().equalsIgnoreCase(universiteOrigine)) return candidat;
		}
	...
	public Candidat getNom(String nom) {
		...
		for(Candidat candidat: cdt) {
			if(candidat.getNom().equalsIgnoreCase(nom)) return candidat;
		}
